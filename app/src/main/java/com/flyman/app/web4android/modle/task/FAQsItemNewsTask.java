...
public class FAQsItemNewsTask extends NewsTask {
    ...
    public FAQsItemNewsTask(int taskId, int totalCodes, int pageNum) {
        super(taskId);
        this.totalCodes = totalCodes;
        this.pageNum = pageNum;
    }

    public FAQsItemNewsTask(int taskId) {
        super(taskId);
    }
    ...
    public interface Type {
        int ALL_QUESTION = 0;//所有问题
        int TO_BE_SOLOVE = 1;//待解决
        int ALREADY_SOLOVED = 2;//已经解决
