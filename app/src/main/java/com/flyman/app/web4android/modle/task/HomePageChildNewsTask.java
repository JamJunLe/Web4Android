...
public class HomePageChildNewsTask extends NewsTask {
    ...
    public HomePageChildNewsTask(int taskId, int totalCodes, int pageNum) {
        super(taskId);
        this.totalCodes = totalCodes;
        this.pageNum = pageNum;
    }

    public HomePageChildNewsTask(int taskId) {
        super(taskId);
    }
