...
import com.flyman.app.web4android.modle.task.ArticleDetailsNewsTask;
...
import static com.flyman.app.web4android.modle.constant.GlobalConstant.IntentExtraKeyConstant.KEY_LIST_2_DETAILS;

public class ArticleDetails extends MVPBaseActivity<ArticleDetailsContract.View,BasePresenter<ArticleDetailsContract.View>> implements IWebClientListener, SuperSwipeRefreshLayout.OnPullRefreshListener, ArticleDetailsContract.View {
    ...
    public void onPresenterStart() {
        ...
        mPresenter.doTask(new ArticleDetailsNewsTask(HomePageChildNewsTask.Type.TASK_ARTICLE_DETAILS));
    ...
    public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
        mProgressBar.setVisibility(View.GONE);
        showError(new Msg(GlobalConstant.MsgConstant.ID_NET_ERROR_, GlobalConstant.MsgConstant.MSG_NET_ERROR));
    }
...
//        mWebView.loadUrl(url);
    ...
    @Override
    protected BasePresenter<ArticleDetailsContract.View> createPresenter() {
        return null;
    }
