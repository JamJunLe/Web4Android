 ...
 * @date 2017/4/6 2:14
 */
public class HomePageItemFragment extends LazyFragment implements HomePageChildContract.View, SuperSwipeRefreshLayout.OnPullRefreshListener, SuperSwipeRefreshLayout.OnPushLoadMoreListener, View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        args = getArguments().getInt(ARGS_HOMEPAGE_CHILD_FRAGMENT);
    ...
    public void onStartPresent() {
        mPresenter.start(new HomePageChildTask(HomePageChildTask.Id.PULL_REFRESH));
    }
    ...
    public void onLoadMore() {
        ...
        mPresenter.start(new HomePageChildTask(HomePageChildTask.Id.PUSH_LOAD_MORE_REFRESH));
    }
