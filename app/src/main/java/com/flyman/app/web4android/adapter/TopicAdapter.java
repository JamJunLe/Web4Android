...
public class TopicAdapter extends RecyclerView.Adapter {
    ...
    public TopicAdapter(ArrayList<Topic> codeList, Context mContext,
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        GlideHelper.loadCircleBitmap(mContext, mCodeViewHolder.iv_topic_member_img,
                mTopicList.get(position).getMemberImg());
    }
